...
QDiscordRoute QDiscordRoutes::Guilds::ban(const QDiscordID& guild,
                                          const QDiscordID& user)
{
    return QDiscordRoute(QDiscordRoute::Method::PUT,
                         QDiscordUtilities::endPoints.guilds
                             + "/{guild}/bans/{user}",
                         guild.toString(),
                         user.toString());
...
QDiscordRoute
QDiscordRoutes::Messages::getPinnedMessages(const QDiscordID& channel)
{
    return QDiscordRoute(QDiscordRoute::Method::GET,
                         QDiscordUtilities::endPoints.channels
                             + "/{channel}/pins",
...
QDiscordRoute
QDiscordRoutes::Messages::addPinnedMessage(const QDiscordID& channel,
                                           const QDiscordID& message)
{
    return QDiscordRoute(QDiscordRoute::Method::PUT,
                         QDiscordUtilities::endPoints.channels
...
QDiscordRoute
QDiscordRoutes::Messages::removePinnedMessage(const QDiscordID& channel,
                                              const QDiscordID& message)
{
    return QDiscordRoute(QDiscordRoute::Method::DELETE,
                         QDiscordUtilities::endPoints.channels
...
QDiscordRoute QDiscordRoutes::Messages::addReaction(const QDiscordID& channel,
                                                    const QDiscordID& message,
...
QDiscordRoute
QDiscordRoutes::Messages::removeReaction(const QDiscordID& channel,
                                         const QDiscordID& message,
                                         const QString& reactionCode,
                                         const QDiscordID& user)
{
...
QDiscordRoute
QDiscordRoutes::Messages::removeAllReactions(const QDiscordID& channel,
                                             const QDiscordID& message)
{
    return QDiscordRoute(QDiscordRoute::Method::DELETE,
                         QDiscordUtilities::endPoints.channels
...
QDiscordRoute
QDiscordRoutes::Messages::getReactionUsers(const QDiscordID& channel,
                                           const QDiscordID& message,
                                           const QString& reactionCode,
                                           int limit)
{
    return QDiscordRoute(QDiscordRoute::Method::GET,
                       ...
                       channel.toString(), message.toString(), reactionCode,
                       QString::number(limit));
}

QDiscordRoute
QDiscordRoutes::Messages::getMessageHistory(const QDiscordID& channel,
                                            int limit)
{
    return QDiscordRoute(QDiscordRoute::Method::GET,
                         QDiscordUtilities::endPoints.channels
...
QDiscordRoute
QDiscordRoutes::Messages::getMessageHistoryBefore(const QDiscordID& channel,
                                                  int limit,
...
QDiscordRoute
QDiscordRoutes::Messages::getMessageHistoryAfter(const QDiscordID& channel,
                                                 int limit,
                                                 const QDiscordID& after)
{
    return QDiscordRoute(
...
QDiscordRoute
QDiscordRoutes::Messages::getMessageHistoryAround(const QDiscordID& channel,
                                                  int limit,
...
QDiscordRoute QDiscordRoutes::Messages::getMessage(const QDiscordID& channel,
                                                   const QDiscordID& message)
{
    return QDiscordRoute(QDiscordRoute::Method::GET,
                         QDiscordUtilities::endPoints.channels
...
QDiscordRoute
QDiscordRoutes::Messages::deleteMessages(const QDiscordID& channel)
{
    return QDiscordRoute(QDiscordRoute::Method::POST,
                         QDiscordUtilities::endPoints.channels
...
{
    return QDiscordRoute(QDiscordRoute::Method::GET,
                         QDiscordUtilities::endPoints.apiBase
                             + "/invites/{code}",
                         code);
}
...
QDiscordRoute
QDiscordRoutes::Invites::getChannelInvites(const QDiscordID& channel)
{
    return QDiscordRoute(QDiscordRoute::Method::GET,
                         QDiscordUtilities::endPoints.channels
                             + "/{channel}/invites",
